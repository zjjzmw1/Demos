...
class FavoriteButton: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        starButton.addTarget(self, action: #selector(FavoriteButton.tappedButton(_:)), for: UIControlEvents.touchUpInside)
        ...
        heartButton.addTarget(self, action: #selector(FavoriteButton.tappedButton(_:)), for: UIControlEvents.touchUpInside)
        ...
        likeButton.addTarget(self, action: #selector(FavoriteButton.tappedButton(_:)), for: UIControlEvents.touchUpInside)
        ...
        smileButton.addTarget(self, action: #selector(FavoriteButton.tappedButton(_:)), for: UIControlEvents.touchUpInside)
        ...
        Custom.showAlertView(str: "CALayer动画", delegate: self)
